...
public class DataCopierModuleStarterImp extends ModuleStarter
		implements DataCopierModuleStarter {
	private DataCopierFactory dataAtomicFactory;
	...
	public void startUsingDataCopierFactoryImplementations(
		...
		dataAtomicFactory = getImplementationThrowErrorIfNoneOrMoreThanOne(
				loggerFactoryImplementations, "DataCopierFactory");
	}
